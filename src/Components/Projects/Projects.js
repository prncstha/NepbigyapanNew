...
const Projects = ({ id }) => {
  return (
    <div id={id}>
      <section class='text-gray-400 body-font bg-white-900'>
        <div class='container px-5 py-10 md:py-20 mx-auto'>
          <div class='flex flex-wrap w-full mb-20'>
            <div class='lg:w-1/2 w-full mb-6 lg:mb-0'>
              <h1 class='sm:text-3xl text-2xl font-extrabold title-font mb-2 text-black ' >
                Here's our projects.
              </h1>
              <div class='h-1 w-20 bg-indigo-500 rounded'></div>
            </div>
            <p class='lg:w-1/2 w-full leading-relaxed text-black text-opacity-100 font-bold'>
          ...
          <div class='flex flex-wrap -m-4'>
            <div class='xl:w-1/4 md:w-1/2 p-4'>
              <div class='bg-white-800 bg-opacity-100  border-blue-800 border p-6 rounded-lg shadow hover:shadow-2xl'>
                <img
                  ...
                  alt='content'
                />
                <h3 class='tracking-widest text-blue-800 text-xl font-bold title-font'>
                  Restaurant Management System
                </h3>
                <h2 class='text-lg text-black font-medium title-font mb-4'>
                  RestroApp
                </h2>
